...
***I am An Open Source Character Catcher Bot...​Add Me in Your group.. And I will send Random Characters After.. every 100 messages in Group... Use /guess to.. Collect that Characters in Your Collection.. and see Collection by using /collection... So add in Your groups and Collect Your harem***
        """
        
        keyboard = [
            [InlineKeyboardButton("ADD ME", url=f'http://t.me/{BOT_USERNAME}?startgroup=new')],
            [InlineKeyboardButton("JOIN THIS", url=f'https://t.me/{SUPPORT_CHAT}'),
            InlineKeyboardButton("UPDATE HAREM REQUEST", url=f'https://t.me/{UPDATE_CHAT}')],
